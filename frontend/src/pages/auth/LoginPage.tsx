...
const LoginPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4 sm:px-6 py-8 relative overflow-hidden">
      {/* Animated Background */}
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="text-center mb-6 sm:mb-8 no-select">
          <Link to="/" className="inline-flex items-center space-x-2 sm:space-x-3 mb-4 sm:mb-6 hover-lift focus-ring">
            ...
            <span className="text-xl sm:text-2xl font-bold text-white">CodeForge</span>
          </Link>
          <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">Welcome back</h1>
          <p className="text-sm sm:text-base text-gray-400 text-selectable">Sign in to your account to continue</p>
        </div>

        {/* Login Form */}
        <div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-6 sm:p-8 backdrop-blur-sm hover:bg-gray-800/50 transition-all duration-500">
          <LoginForm />
